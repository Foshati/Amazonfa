import data from "@/lib/sample-data"
import Image from "next/image"

export default function ProductDetails({ params, }: { params: { slug: string } }) {
    const productDetails = data.products.find((x) => x.slug === params.slug)
    if (!productDetails) {
                            ...
                            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                ...
                                <div className="flex mb-4">
                                    <span className="flex items-center">
                                        ...
                                        <span className="text-gray-600 ml-3">{productDetails.rating}</span>
                                    </span>
                                    <span className="flex ml-3 pl-3 py-2 border-l-2 border-gray-200 space-x-2s">
                                        <span className="text-slate-600" >Number of products:{productDetails.countInStock}</span>
                                    </span>
                                </div>
